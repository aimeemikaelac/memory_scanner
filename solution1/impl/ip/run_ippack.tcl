...
set Library     "hls"
set IPName      "memory_scanner"
set Version     "1.0"
set DisplayName "Memory_scanner"
set Revision    "1601190441"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "memory_scanner"
...
set Interfaces {
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_m_mm2s_ctl m_axi_m_s2mm_ctl s_in_V_V s_out_V_V"
    }
    ap_rst_n {
        type "reset"
        polarity "ACTIVE_LOW"
    ...
    m_axi_m_mm2s_ctl {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_m_mm2s_ctl"
        data_width "32"
        param_prefix "C_M_AXI_M_MM2S_CTL"
    ...
    m_axi_m_s2mm_ctl {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_m_s2mm_ctl"
        data_width "32"
        param_prefix "C_M_AXI_M_S2MM_CTL"
        port_width "AWADDR 32 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 32 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
